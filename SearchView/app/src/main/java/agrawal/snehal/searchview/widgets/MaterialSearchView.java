package agrawal.snehal.searchview.widgets;
...
import agrawal.snehal.searchview.R;
import agrawal.snehal.searchview.interfaces.onSearchActionsListener;
...
import agrawal.snehal.searchview.utils.Util;
...
public class MaterialSearchView extends FrameLayout implements View.OnClickListener, onSearchActionsListener {
    ...
    public MaterialSearchView(final Context context, final AttributeSet attrs, final int defStyle) {
        ...
        ImageView backArrowImg = (ImageView) findViewById(R.id.image_search_back);
